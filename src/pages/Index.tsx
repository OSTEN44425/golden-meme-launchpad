    ...
    <div className="min-h-screen bg-black text-white overflow-x-hidden font-sans relative">
              ...
              <FadeContent delay={300}>
                <Card className="glowing-border glass-effect bg-gradient-to-br from-violet-500/10 to-purple-500/10 backdrop-blur-sm border-violet-500/30 relative shadow-xl h-full flex flex-col hover-scale">
                  <CardHeader className="pb-6">
                    <Badge className="bg-black/40 backdrop-blur-xl border border-slate-700/40 font-bold px-4 py-1 text-sm mb-4 w-fit">
      ...
      <FadeContent>
        <section id="edge" className="py-8 relative">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-4xl lg:text-5xl font-bold mb-4 whitespace-nowrap">
                ...
                <Card className="glowing-border glass-effect bg-gradient-to-br from-violet-500/10 to-purple-500/10 backdrop-blur-sm border-violet-500/30 relative shadow-xl hover-scale">
                  <CardContent className="p-16 text-center relative">
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                      <div className="bg-black/40 backdrop-blur-xl border border-slate-700/40 font-bold px-8 py-3 text-base rounded-full shadow-lg">
              ...
              <div className="relative group">
                ...
                <div className="relative bg-black/80 backdrop-blur-sm border-slate-700/50 border rounded-3xl overflow-hidden hover-scale transition-all duration-300 hover:border-slate-600/60 hover:shadow-2xl hover:shadow-black/20">
                  ...
                  <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    <div className="absolute top-8 left-8 w-10 h-10 text-slate-300/40 opacity-90">
                    ...
                    <div className="absolute top-8 right-8 w-10 h-10 text-slate-300/40 opacity-90">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
                    ...
                    <div className="absolute bottom-8 left-8 w-10 h-10 text-slate-300/40 opacity-90">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
                    ...
                    <div className="absolute bottom-8 right-8 w-10 h-10 text-slate-300/40 opacity-90">
                      <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full">
                        <path d="M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515a.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0a12.64 12.64 0 0 0-.617-1.25a.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057a19.9 19.9 0 0 0 5.993 3.03a.078.078 0 0 0 .084-.028a14.09 14.09 0 0 0 1.226-1.994a.076.076 0 0 0-.041-.106a13.107 13.107 0 0 1-1.872-.892a.077.077 0 0 1-.008-.128a10.2 10.2 0 0 0 .372-.292a.074.074 0 0 1 .077-.01c3.928 1.793 8.18 1.793 12.062 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127a12.299 12.299 0 0 1-1.873.892a.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028a19.839 19.839 0 0 0 6.002-3.03a.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.03zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419c0-1.333.956-2.419 2.157-2.419c1.21 0 2.176 1.096 2.157 2.42c0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419c0-1.333.955-2.419 2.157-2.419c1.21 0 2.176 1.096 2.157 2.42c0 1.333-.946 2.418-2.157 2.418z"/>
                      </svg>
                    </div>
                  ...
                  <div className="relative p-16 text-center">
                    ...
                    <FadeContent delay={600}>
                      <div className="flex flex-col sm:flex-row items-center justify-center space-y-6 sm:space-y-0 sm:space-x-8">
                        <button className="group/btn relative bg-black/20 backdrop-blur-xl border border-violet-400/50 text-white hover:text-white font-bold px-12 py-6 transition-all duration-300 shadow-2xl rounded-2xl overflow-hidden hover:scale-105 hover:shadow-[0_20px_40px_rgba(139,92,246,0.3)] hover:border-violet-400/70">
      ...
      <FadeContent>
        <section id="cta-final" className="py-20 relative">
          <div className="container mx-auto px-6 text-center">
            <h2 className="text-3xl lg:text-4xl font-bold mb-8 whitespace-nowrap">

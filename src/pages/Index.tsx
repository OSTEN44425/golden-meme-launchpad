...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-x-hidden font-sans relative">
      ...
      {/* Community Section - WITHOUT decorative icons */}
      <FadeContent>
            ...
            <FadeContent delay={200}>
              <div className="relative group">
                ...
                <div className="relative bg-black/80 backdrop-blur-sm border-violet-500/40 border rounded-3xl overflow-hidden hover-scale transition-all duration-300 hover:border-violet-500/60 hover:shadow-2xl hover:shadow-black/20">
                  {/* Remove all decorative background icons */}
                  ...
                  <div className="relative p-16 text-center">
                    ...
                    <FadeContent delay={600}>
                      <div className="flex flex-col sm:flex-row items-center justify-center space-y-6 sm:space-y-0 sm:space-x-8">
                        <button className="group/btn relative bg-black/50 backdrop-blur-xl border border-slate-600/40 text-slate-300 hover:text-slate-200 font-bold px-12 py-6 transition-all duration-300 shadow-2xl rounded-2xl overflow-hidden hover:scale-105 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)] hover:border-slate-500/50 hover:bg-black/60">
                          <div className="absolute -inset-2 bg-gradient-to-r from-black/20 via-slate-700/30 to-black/20 rounded-3xl blur-lg opacity-60 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
                          <div className="absolute inset-0 bg-gradient-to-r from-transparent via-slate-500/10 to-transparent translate-x-[-100%] group-hover/btn:translate-x-[100%] transition-transform duration-700"></div>
